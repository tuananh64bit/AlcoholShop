        ...
        <nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-gold" href="${pageContext.request.contextPath}/admin/contacts">
                    ...
                    <div class="card bg-glass border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-gold text-uppercase mb-1">Total Messages</div>
                                    <div class="h5 mb-0 font-weight-bold text-white">${totalMessages}</div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card bg-glass border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-gold text-uppercase mb-1">New Messages</div>
                                    <div class="h5 mb-0 font-weight-bold text-white">${newMessages}</div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card bg-glass border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-gold text-uppercase mb-1">Replied</div>
                                    <div class="h5 mb-0 font-weight-bold text-white">${repliedMessages}</div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card bg-glass border-left-warning shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-gold text-uppercase mb-1">This Month</div>
                                    <div class="h5 mb-0 font-weight-bold text-white">${monthlyMessages}</div>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <c:when test="${not empty messages}">
                                        <c:forEach var="message" items="${messages}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="mailto:${message.email}" class="text-gold">
                                                        ${message.email}
                                                    </a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="badge ${message.status == 'NEW' ? 'bg-warning' : message.status == 'READ' ? 'bg-info' : 'bg-success'}">
                                                        ${message.status}
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="${pageContext.request.contextPath}/admin/contacts?action=view&id=${message.id}" 
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/admin/contacts?action=delete&id=${message.id}" 
